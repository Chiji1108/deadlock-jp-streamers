...
export function LivePreview({
  ...
  return (
    <a
      ...
      className="group flex flex-col gap-4 rounded-md focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring sm:flex-row sm:items-center"
    >
      {src && (
      ...
      <div className="flex min-w-0 flex-col gap-2">
        ...
        <h2 className="break-words text-sm font-medium group-hover:underline">
          {live.title}
        </h2>
      </div>
    </a>
